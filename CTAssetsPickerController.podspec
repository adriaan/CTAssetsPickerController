Pod::Spec.new do |spec|
  ...
  spec.source                = { :git => 'https://github.com/chiunam/CTAssetsPickerController.git', :tag => 'v3.0.0' }
  spec.public_header_files   = 'CTAssetsPickerController/*.h'
  spec.source_files          = 'CTAssetsPickerController/**/*.{h,m}'
  spec.resource_bundles      = { 'CTAssetsPickerController' => ['CTAssetsPickerController/Resources/CTAssetsPicker.xcassets/*/*.png', 'CTAssetsPickerController/Resources/*.lproj', 'CTAssetsPickerController/Resources/*.otf'] }
